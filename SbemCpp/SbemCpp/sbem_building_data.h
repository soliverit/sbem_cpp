...
*/
class SbemBuildingData : public SbemObject {

	/*=== Constructors ===*/
	/* Default */
	SbemBuildingData();
	/* Create blank BUILDING-DATA */
	SbemBuildingData(std::string objectName);
	/* Create complete BUILDING-DATA */
	SbemBuildingData(std::string objectName, std::vector<std::string> propertyStrings);
public:
	/*=== Static methods===*/
	/* SBEM object name: BUILDING-DATA */
